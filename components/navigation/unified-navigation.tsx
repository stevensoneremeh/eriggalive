          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative hidden sm:block">
              ...
              <input
                ...
                className="w-64 rounded-lg border bg-background/50 py-2 pl-10 pr-4 text-sm backdrop-blur focus:outline-none focus:ring-2 focus:ring-primary/50 dark:bg-background/80"
              />
            </div>
