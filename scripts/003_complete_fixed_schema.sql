...
-- Fixed jsonb insertion by using proper JSONB literal format
INSERT INTO public.audit_logs (action, table_name, new_values) 
VALUES ('schema_creation', 'system', '{"message": "Complete Erigga Live production schema created successfully", "version": "1.0"}');
