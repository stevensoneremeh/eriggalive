...
import { Eye, EyeOff, AlertCircle, RefreshCw, Loader2 } from "lucide-react"
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <Card className="w-full max-w-md border-red-200">
          <CardHeader>
            ...
            <CardDescription className="text-center">We're having trouble connecting to our servers</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardFooter className="flex flex-col space-y-2">
            ...
            <p className="text-xs text-muted-foreground text-center">If the problem persists, please contact support</p>
          </CardFooter>
        </Card>
      </div>
    )
