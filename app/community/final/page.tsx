...
export default async function CommunityFinalPage() {
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="font-semibold">{post.users.full_name}</span>
                            <Badge className={`${getTierColor(post.users.tier)} text-white text-xs`}>
